window.RECIPE_VOICE_CONFIG = {
  ...
  strings: {
    ...
    stepsTitle: "烹調步驟",
    changedBadge: "已調整",
    cursorAiTitle: "Cursor AI 即時生成",
    cursorAiHint: "使用 Cursor Cloud Agents API 即時生成素食版／健康版（需 API key）。",
    cursorKeyLabel: "Cursor API Key",
    cursorKeyPlaceholder: "crsr_…（來自 Cursor Dashboard → API Keys）",
    cursorSaveKey: "儲存並連線",
    cursorConnected: "已連線 Cursor AI",
    cursorDisconnected: "未連線 — 將使用預設靜態版本",
    cursorGenerating: "Cursor AI 正在生成食譜…",
    cursorStreamLabel: "Cursor AI",
    cursorError: (msg) => `Cursor AI 錯誤：${msg}`,
    cursorUseAi: "使用 Cursor AI 即時生成",
  },
  commands: {
    start: ["開始", "播放", "朗讀"],
    next: ["下一步", "下一個"],
