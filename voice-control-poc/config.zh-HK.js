...
window.RECIPE_VOICE_CONFIG = {
  ...
  strings: {
    ...
    cookModeTitle: "烹調模式",
    cookModeHint: "烹調時保持螢幕常亮，並開啟語音控制。",
    cookModeOn: "開啟",
    cookModeOff: "關閉",
    cookModeOffHint: "開啟烹調模式以保持螢幕常亮，並使用免提語音控制。",
    cookModeActive: "烹調模式已開啟 — 螢幕將保持常亮，語音聆聽已啟動。",
    cookModeWakeLockOk: "螢幕常亮已啟用。",
    cookModeWakeLockFallback: "此裝置不支援螢幕常亮 — 烹調時請保持此頁面可見。",
    cookModeWakeLockDenied: "無法保持螢幕常亮 — 請檢查瀏覽器權限後再試。",
    cookModeEnded: "已結束烹調模式 — 螢幕及語音控制已恢復一般狀態。",
