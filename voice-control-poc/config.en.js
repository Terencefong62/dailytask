window.RECIPE_VOICE_CONFIG = {
  ...
  strings: {
    ...
    cursorAiTitle: "Cursor AI (real-time)",
    cursorAiHint: "Generate Vegan / Healthy versions instantly via Cursor Cloud Agents API.",
    cursorKeyLabel: "Cursor API Key",
    cursorKeyPlaceholder: "crsr_… (from Cursor Dashboard → API Keys)",
    cursorSaveKey: "Save & connect",
    cursorConnected: "Connected to Cursor AI",
    cursorDisconnected: "Not connected — static fallback will be used",
    cursorGenerating: "Cursor AI is generating the recipe…",
    cursorStreamLabel: "Cursor AI",
    cursorError: (msg) => `Cursor AI error: ${msg}`,
    cursorUseAi: "Use Cursor AI for Vegan / Healthy",
  },
  commands: {
